...
slmpack - convert the ARPA format of laipinyin back-off language model to its binary representation
...
B<slmpack> converts the ARPA format of a threaded laipinyin back-off
