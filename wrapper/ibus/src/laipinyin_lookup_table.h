...
#ifndef laipinyin_LOOKUP_TABLE_H
#define laipinyin_LOOKUP_TABLE_H
 ...
 */
class laipinyinLookupTable : public ibus::LookupTable
{
public:
    laipinyinLookupTable();
    virtual ~laipinyinLookupTable();
    /**
...
#endif // laipinyin_LOOKUP_TABLE_H
