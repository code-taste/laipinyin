...
#ifndef laipinyin_CONFIG_H
#define laipinyin_CONFIG_H
...
class laipinyinConfig
{
    typedef std::map<std::string,
        ClaipinyinSessionFactory::EPyScheme> SchemeNames;
    typedef std::map<std::string,
...
public:
    ...
    ClaipinyinSessionFactory::EPyScheme get_py_scheme(ClaipinyinSessionFactory::EPyScheme);
    void set_py_scheme(ClaipinyinSessionFactory::EPyScheme);
...
private:
    ...
    std::string get_scheme_name(ClaipinyinSessionFactory::EPyScheme scheme);
    ClaipinyinSessionFactory::EPyScheme get_scheme(const std::string& name);
};

#endif // laipinyin_CONFIG_H
