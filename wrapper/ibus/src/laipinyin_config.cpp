...
IBusConfig* laipinyinConfig::m_config;

laipinyinConfig::laipinyinConfig()
{
    m_scheme_names["QuanPin"]    = ClaipinyinSessionFactory::QUANPIN;
    m_scheme_names["ShuangPin"]  = ClaipinyinSessionFactory::SHUANGPIN;
}
...
void
laipinyinConfig::set_config(IBusConfig* config)
{
    assert(config);
    m_config = config;
    listen_on_changed();
...
ClaipinyinSessionFactory::EPyScheme
laipinyinConfig::get_py_scheme(ClaipinyinSessionFactory::EPyScheme scheme)
{
    string default_name =
...
bool
laipinyinConfig::is_initial_mode_cn()
{
...
bool
laipinyinConfig::is_initial_punct_full()
{
...
bool
laipinyinConfig::is_initial_letter_full()
{
...
void
laipinyinConfig::listen_on_changed()
{
...
std::string
laipinyinConfig::get_scheme_name(ClaipinyinSessionFactory::EPyScheme scheme)
{
...
ClaipinyinSessionFactory::EPyScheme
laipinyinConfig::get_scheme(const std::string& name)
{
    ClaipinyinSessionFactory::EPyScheme val = ClaipinyinSessionFactory::SHUANGPIN;
...
bool
laipinyinConfig::get(const char* key, bool val)
{
    assert(m_config != NULL);
...
void
laipinyinConfig::set(const char* key, bool val)
{
    assert(m_config != NULL);
...
std::string
laipinyinConfig::get(const char* key, const std::string& val)
{
    assert(m_config != NULL);
...
void
laipinyinConfig::set(const char* key, const std::string& val)
{
    assert(m_config != NULL);
...
int
laipinyinConfig::get(const char* key, int val)
{
    assert(m_config != NULL);
...
void 
laipinyinConfig::set(const char* key, int val)
{
    assert(m_config != NULL);
...
laipinyinConfig::get(const char* key, const std::vector<std::string>& val)
{
    assert(m_config != NULL);
...
void
laipinyinConfig::on_config_value_changed(IBusConfig *config,
                                         const gchar *section,
                                         const gchar *name,
                                         GVariant *value,
                                         laipinyinConfig* thiz)
{
    static const char* prefix = "engine/laipinyin/";
...
void
laipinyinConfig::set(const char* key, bool value)
{
    assert(m_config != NULL);
...
void 
laipinyinConfig::set(const char* key, int value)
{
    assert(m_config != NULL);
