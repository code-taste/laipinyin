...
laipinyinLookupTable::laipinyinLookupTable()
...
int
laipinyinLookupTable::update_candidates(const ICandidateList& cl)
{
...
bool
laipinyinLookupTable::cursor_up()
{
...
bool
laipinyinLookupTable::cursor_down()
{
...
size_t
laipinyinLookupTable::get_cursor_pos() const
{
    return ibus_lookup_table_get_cursor_pos(*this);
}

void
laipinyinLookupTable::decorate_candidate(ibus::Text text, int type)
{
    switch (type) {
...
int
laipinyinLookupTable::get_current_page_start() const
{
