...
#define SCIM_PROP_STATUS                  "/IMEngine/laipinyin/Status"
#define SCIM_PROP_LETTER                  "/IMEngine/laipinyin/Letter"
#define SCIM_PROP_PUNCT                   "/IMEngine/laipinyin/Punct"

#ifndef SCIM_laipinyin_DATADIR
    #define SCIM_laipinyin_DATADIR            "/usr/share/scim/laipinyin"
#endif
...
#ifndef SCIM_laipinyin_ICON_FILE
    #define SCIM_laipinyin_ICON_FILE       (SCIM_ICONDIR "/laipinyin_logo.png")
#endif
      ...
      m_valid (false)
{
    ...
    set_languages ("zh_CN");
    m_name = utf8_mbstowcs ("laipinyin");
    m_valid = init ();
...
{
    return String (SCIM_laipinyin_ICON_FILE);
}
...
SunPyInstance::create_session(CHotkeyProfile *hotkey_profile)
{
    ...
    factory.setPinyinScheme(ClaipinyinSessionFactory::QUANPIN);
