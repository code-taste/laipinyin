...
#include "common.h"
#include "settings.h"
#include "laipinyin_preedit_ui.h"
...
preedit_init()
{
    ClaipinyinSessionFactory& fac = ClaipinyinSessionFactory::getFactory();
    if (settings_get_int(SHUANGPIN)) {
        fac.setPinyinScheme(ClaipinyinSessionFactory::SHUANGPIN);
        // shuangpin schemes
        varchar scheme;
        ...
        fac.setPinyinScheme(ClaipinyinSessionFactory::QUANPIN);
    }
