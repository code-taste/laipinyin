...
// Note: the laipinyinApplicationDelegate is instantiated automatically as an outlet of NSApp's instance
@interface laipinyinApplicationDelegate : NSObject <NSWindowDelegate, GrowlApplicationBridgeDelegate>
{
